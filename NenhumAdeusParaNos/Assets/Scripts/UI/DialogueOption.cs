...
public class DialogueOption : MonoBehaviour
{
    ...
    public void SetOption(string text, int id, Dialogue dialogue, IDialogueable theNPC, Player player)
    {
        optionText = GetComponent<Text>();
    ...
    public void Choose()
    {
        ...
        GameManager.gameManager.dialogueController.ChooseOption(myDialogue, myDialogue.MyNPC.GetPortrait()/*expressions[1]*/);          
    }
}
